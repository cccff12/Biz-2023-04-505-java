...
//	player가 get한 카드를 저장할 list
	protected final List<CardDto> deckList;
	protected final String playName;

	/*
	 * new playerservice()으로 생성자를 호출하면 playername을 "딜러"로 설정 new playerservice 으로
	 * 생성자를 호출하면 playername을 "타짜"로 설정
	 */
	...
	public void showDeck() {
		...
		System.out.printf("%s, 받은카드: %d매, 점수 : %d\n", playName, deckList.size(), this.getScore());
		System.out.println(Line.dLine(100));
