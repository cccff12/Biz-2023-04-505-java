...
/*
 * `데이터 추상화` 
 * 일상의 데이터를 컴퓨터를 사용해 정보처리를 하려고 할때
 * 일상의 데이터를 필요한 속성(요소)만 추출하는 과정
 * 
