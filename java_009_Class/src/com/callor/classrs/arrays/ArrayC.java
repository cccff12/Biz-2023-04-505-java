...
public class ArrayC {
	...
	public static void main(String[] args) {
		...
		System.out.println("-".repeat(60));
		int korall = 홍길동.scKor + 성춘향.scKor + 이몽룡.scKor;
		int engall = 홍길동.scEng + 성춘향.scEng + 이몽룡.scEng;
		int mathall = 홍길동.scMath + 성춘향.scMath + 이몽룡.scMath;
		int all = korall + engall + mathall;

		System.out.println(" ".repeat(18) + korall + "\t  " + engall + "\t  " + mathall + "\t" + all);
		System.out.println("=".repeat(60));
