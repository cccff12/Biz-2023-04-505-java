...
public class HomeWork {
	...
	public static void main(String[] args) {
		...
		int alleng=scores[0].scEng+scores[1].scEng+scores[2].scEng+scores[3].scEng+scores[4].scEng+scores[5].scEng+
				scores[6].scEng+scores[7].scEng+scores[8].scEng+scores[9].scEng;
		int allMath=scores[0].scMath+scores[1].scMath+scores[2].scMath+scores[3].scMath+scores[4].scMath+scores[5].scMath+
				scores[6].scMath+scores[7].scMath+scores[8].scMath+scores[9].scMath;
