...
public class ControllerG {
	 ...
	 * 
	 * prime()method{}내에서 선언했던 ran변수를 매개변수(parameter)로 변경하기 매개변수는 스스로 초기화 할수 없다. 누군가
	 * prime() method를 호출하면서 값을 전잘해주어야만 그 값으로 초기화 할수 있다. prime(int ran=0) 과 같은 코드
	 * 사용불가
	 * 
	 * main()에서 prime(55)와 같은 코드가 실행될때 매개변수 값이 초기화 된다.
	 * 
	 */
