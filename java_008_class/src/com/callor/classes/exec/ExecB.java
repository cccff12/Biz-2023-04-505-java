...
public class ExecB {
	...
	public static void main(String[] args) {
		/*
		 * scoredto 클래스를 사용해 scoredto객체를 선언하고 생성자 method (scoredto())를 사용해 객체를
		 * 초기화(new)한다.
		 * 
		 * scoreDto 객체를 초기화하여 사용할 준비가 되면 인스턴스가 되었다. 라고 표현한다
		 * 
		 * scoreDto객체를 초기화 하는 순간 ScoreDto 클래스에서 선언한 변수들 을 모두 사용할수 있도록 동시에 초기화가 된다.
		 */
